...
$accountInfo = $user->get_account_info();
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="card shadow mb-4 border-left-primary">
                                ...
                                <div class="card-body">
                                    <p>Firstname: <?php echo $accountInfo['firstname']; ?></p>
                                    <p>Lastname: <?php echo $accountInfo['lastname']; ?></p>
                                    <p>Email: <?php echo $accountInfo['email']; ?></p>
